...
(defconst darcamo-rtags-overrides
  '(("C-]" 'rtags-find-symbol-at-point)
    ("M-." 'rtags-find-symbol-at-point)))

(defun darcamo-rtags-set-evil-keys ()
  (dolist (override darcamo-rtags-overrides)
    (evil-local-set-key 'normal (car override) (cdr override))))

(add-hook 'c-mode-common-hook 'darcamo-rtags-set-evil-keys)
