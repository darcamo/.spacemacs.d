...
values."
  (setq-default
   ...
   '(
     ...
     ;; ----------------------------------------------------------------
     ;; Documentação das layers: http://spacemacs.org/layers/LAYERS.html
     ;; ivy
     helm
   ...
   dotspacemacs-additional-packages '(string-utils helm-unicode ninja-mode gxref)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (lsp-python lsp-ui company-lsp cquery lsp-mode github-clone yasnippet-snippets auctex-latexmk list-utils spinner pdf-tools key-chord tablist org-category-capture ht alert log4e gntp markdown-mode hydra dash-functional parent-mode xcscope parsebib haml-mode flyspell-correct pkg-info epl flx let-alist iedit anzu goto-chg undo-tree highlight skewer-mode request-deferred websocket request deferred js2-mode simple-httpd makey web-completion-data pos-tip bind-map biblio biblio-core anaconda-mode pythonic f s dash ace-jump-mode avy async auto-complete popup powerline ivy packed multiple-cursors auctex smartparens evil yasnippet gitignore-mode magit-popup with-editor projectile org-plus-contrib helm-bibtex interleave company web-mode use-package mmm-mode evil-magit adaptive-wrap flycheck helm helm-core magit ghub yapfify yaml-mode ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen unfill toc-org tagedit synosaurus string-utils stickyfunc-enhance srefactor spaceline smeargle slim-mode scss-mode sass-mode restart-emacs rainbow-mode rainbow-delimiters pyvenv pytest pyenv-mode py-isort pug-mode popwin plantuml-mode pip-requirements persp-mode pcre2el paradox orgit org-ref org-projectile org-present org-pomodoro org-mime org-download org-bullets open-junk-file ninja-mode neotree mwim mu4e-maildirs-extension mu4e-alert move-text markdown-toc magit-gitflow macrostep lorem-ipsum live-py-mode linum-relative link-hint less-css-mode indent-guide ibuffer-projectile hy-mode hungry-delete htmlize hl-todo highlight-symbol highlight-parentheses highlight-numbers highlight-indentation helm-unicode helm-themes helm-swoop helm-pydoc helm-projectile helm-mode-manager helm-make helm-gitignore helm-flx helm-descbinds helm-css-scss helm-cscope helm-company helm-c-yasnippet helm-ag gxref graphviz-dot-mode goto-last-change google-translate golden-ratio gnuplot gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter git-commit gh-md fuzzy flyspell-correct-helm flycheck-pos-tip flx-ido fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-args evil-anzu eval-sexp-fu emmet-mode elisp-slime-nav ein dumb-jump discover-my-major disaster diminish define-word cython-mode csv-mode conda company-web company-statistics company-quickhelp company-c-headers company-auctex company-anaconda comment-dwim-2 column-enforce-mode cmake-mode clean-aindent-mode clang-format buffer-move bind-key auto-yasnippet auto-highlight-symbol auto-dictionary auto-compile aggressive-indent ace-window ace-mc ace-link ace-jump-helm-line ac-ispell))))
(custom-set-faces
